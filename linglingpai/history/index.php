    ...
    <div class="wrapper bgded overlay">
      ...
      <footer>
        <ul class="nospace inline pushright">
          <li><a id="sign_in" class="btn" href="https://ac.ppdai.com/oauth2/login?AppID=3bec630951ea46beb1acf8768c486dcd&ReturnUrl=http://106.14.115.248/linglingpai/info.php">登    录</a></li>
          <li><a id="sign_up" class="btn inverse" href="https://ac.ppdai.com/User/Register">注    册</a></li>
        </ul>
      </footer>
    </article>
    <!-- ################################################################################################ -->
...
<div class="wrapper">
    <section class="hoc container clear">
        <h2 class="font-x3 uppercase btmspace-80 underlined"><a href="#">借款人的一些人口基本统计信息</a></h2>
        <div id="part2">
            <div style="width: 1200px;height:350px;" >
                <div id="user_age" style="width: 500px;height:350px;float:left"></div>           
                <br>
            </div>
        </div>
    </section>
