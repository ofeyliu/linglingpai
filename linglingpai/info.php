...
<div class="wrapper row2">
  <section class="hoc container clear"> 
      <h2 class="font-x3 uppercase btmspace-80 underlined"><a href="#">投标详情:</a></h2>
      <div id="bidsInfo"><b></b></div>
      <ul class="nospace elements"> </ul>
  </section>
</div>
...
var xmlhttp3;
  ...
  xmlhttp3.onreadystatechange=function()
  {
    if (xmlhttp3.readyState==4 && xmlhttp3.status==200)
    {
      document.getElementById("bidsInfo").innerHTML=xmlhttp3.responseText;
    }
  }
  xmlhttp3.open("GET","/linglingpai/php/bidsInfo.php",true);
  xmlhttp3.send();
